...
<div class="reg">
    <form action="Register" method="post" onsubmit="return checkForm(this)">
        ...
        <p style="text-align:center;font-size:30px">用户注册</p>
        ...
        <p>
        <input style="width:20px;height:20px" type="radio" name="sex" value="M" checked="checked">男
        <input style="width:20px;height:20px" type="radio" name="sex" value="F" checked="checked">女
        </p>
        <p><input type="date" name="birthday" value="" placeholder="请确输入出生日期"><span></span></p>
        ...
        <p class="txtL">完成此注册，即表明您同意了我们的<a href="#"><使用条款和隐私策略></a></p>
